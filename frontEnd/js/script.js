  ...
  <div class="col d-flex align-items-stretch bg-transparent" id="cloneList${i}">
    <div class="card border border-0 bg-transparent" style="width: 30rem;">
      ...
      <li><a class="dropdown-item" href="#">Elimina
        ...
        </ul> </div></div><div class="card-body " data-bs-toggle="modal" data-bs-target="#staticBackdrop${i}"> 
          `;
  return ordineHeader;
} // end ordineHeader ()
        ...
        <div class="modal-body">
          <div class="card  border border-0 mb-4">
            ...
            <div class="card-header  d-flex justify-content-between">
              ...
              <div class="pt-2 ">
                <input class="form-control me-2" type="search" value="${cart.titolo} " aria-label="Search">
...
function D88D8C(cart) {
  let url = `http://localhost:8080/api/ordine/color_update/${cart}`;
  console.log(`${cart}`);
  let coloreId = 1;
  let colores = "#D88D8C";
  let colore = {
    idColoreOrdine: coloreId,
    colore: colores
  };
  ...
  let body = JSON.stringify(colore);
  xhr.send(body);
}
