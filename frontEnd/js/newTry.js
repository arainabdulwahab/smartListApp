...
<div class="mt-1 mb-3 d-flex justify-content-between">
  ...
  <div>
  <img src="images/icone/cartella_icon_alimenti/almond.png" width="30px" height="30px"
  class="p-2 bd-highlight" style="background-color: grey;">
  </div>
  
  <div class="">
    <input class="form-control me-2" type="search" value="broccoli " aria-label="Search">
  </div>
  ...
  <div style="width: 50px;">
    <input class="form-control me-2"  value="5 kg " >
  </div>
  
  <div style="width: 50px;">
    <input class="form-control me-2"  value="3 " >
  </div>
</div> <!-- end righa-->
