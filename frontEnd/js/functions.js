    ...
    <div class="modal-body">
      <div class="card  border border-0 mb-4">
        ...
        <div class="card-header  d-flex justify-content-between">
          ...
          <div class="pt-2 ">
            <input class="form-control me-2" value="   " aria-label="Search">
...
function sfondoModal(i) {
    ...
    <div class="modal-body">
      <div class="d-flex justify-content-start text-center">
        ...
        <div class="d-inline m-1 p-1">
          <div class="rounded-circle m-1 sfondo-ordine" style="width: 50px; height: 50px; background-color:#D9AF77;" data-sfondo="#D9AF77" data-ordine="${i}"></div>
          <div class="rounded-circle m-1 sfondo-ordine" style="width: 50px; height: 50px; background-color:#ADD3D9;" data-sfondo="#ADD3D9" data-ordine="${i}"></div>
        </div>
        <div class="d-inline m-1 p-1">
          <div class="rounded-circle m-1 sfondo-ordine" style="width: 50px; height: 50px; background-color:#9EACD9;" data-sfondo="#9EACD9" data-ordine="${i}"></div>
          <div class="rounded-circle m-1 sfondo-ordine" style="width: 50px; height: 50px; background-color:#D9B6D3;" data-sfondo="#D9B6D3" data-ordine="${i}"></div>
        </div>
        <div class="d-inline m-1 p-1">
          <div class="rounded-circle m-1 sfondo-ordine" style="width: 50px; height: 50px; background-color:#B5D877;" data-sfondo="#B5D877" data-ordine="${i}"></div>
          <div class="rounded-circle m-1 sfondo-ordine" style="width: 50px; height: 50px; background-color:#D9C775;" data-sfondo="#D9C775" data-ordine="${i}"></div>
        </div>
      </div>
    </div>
    </div>
